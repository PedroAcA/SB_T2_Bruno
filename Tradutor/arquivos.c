...
void escreve_input(char* arg1,char* arg2,char tipo){
    ...
    if (tipo == 'd'){
        fprintf(obj,"pusha\n");
        fprintf(obj,"mov ecx,string_auxiliar_leitura\n");
...
void imprime_funcoes(){
    ...
    fprintf(obj, "section .data\n");
    fprintf(obj, "mensagem_string_erro     db      'Digitos invalidos', 0AH\n");
    fprintf(obj, "tamanho_string_erro     equ     $-mensagem_string_erro\n");
    fprintf(obj, "resultado_final_auxiliar dd 0\n");
    fprintf(obj, "demarcador_de_sinal db 0\n");
    fprintf(obj, "resultado_final_auxiliar_divisao_parcial db '0000'\n");
    fprintf(obj, "string_auxiliar_leitura db '000000000000'\n");
    fprintf(obj, "ncaracteres dd 0  \n");
    fprintf(obj, "  \n");
    ...
    fprintf(obj, "\n");
    fprintf(obj, "  ;chamada ao sistema retorna quantidade de caracteres em eax\n");
    fprintf(obj, "  ret\n");
    ...
    fprintf(obj, "  mov dword [ncaracteres],0\n");
    ...
    fprintf(obj, "  push edx ; empilha o resultado_final_auxiliar\n");
    fprintf(obj, "  mov dword  ecx,eax ;coloca o resultado_final_auxiliar_divisao_parcial de volta em ecx\n");
    fprintf(obj, "  \n");
    fprintf(obj, "  cmp ecx,0 ;ve se ja converteu o numero todo\n");
    fprintf(obj, "  je fim1\n");
    fprintf(obj, "  inc dword [ncaracteres]\n");
    fprintf(obj, "  \n");
    ...
    fprintf(obj, "  mov dword [resultado_final_auxiliar], eax ;se não, coloca pra ser impresso\n");
    fprintf(obj, "  \n");
    fprintf(obj, "  mov eax, 4 ; escrever\n");
    fprintf(obj, "  mov ebx, 1 ; monitor\n");
    fprintf(obj, "  mov ecx, resultado_final_auxiliar\n");
    fprintf(obj, "  mov edx, 1\n");
    fprintf(obj, "  int 0x80   ; escrever(monitor, digitado, 1byte);\n");
    fprintf(obj, "  \n");
    ...
    fprintf(obj, "\n");
    fprintf(obj, "  retorno:\n");
    fprintf(obj, "  mov eax, [ncaracteres] ;retorna em eax o num de caracteres\n");
    fprintf(obj, "  ret\n");
    fprintf(obj, "\n");
    fprintf(obj, "LerHexa:\n");
    fprintf(obj, "  mov dword [ncaracteres],0\n");
    fprintf(obj, "  call LerString\n");
    fprintf(obj, "  mov ecx, string_auxiliar_leitura ;aponta para o vetor digitado\n");
    fprintf(obj, "  mov dword [resultado_final_auxiliar],0\n");
    fprintf(obj, "  mov edx, resultado_final_auxiliar ; resultado_final_auxiliar\n");
    fprintf(obj, "inicio2:\n");
    ...
    fprintf(obj, "  ;multiplica o resultado_final_auxiliar por 16\n");
    fprintf(obj, "  shl dword [edx], 4  \n");
    fprintf(obj, "  add dword[edx], ebx ;soma o resultado_final_auxiliar parcial com o digito\n");
    fprintf(obj, "\n");
    fprintf(obj, "  inc ecx ;muda o poneiro pro porximo digito\n");
    fprintf(obj, "  jmp inicio2\n");
    fprintf(obj, "\n");
    fprintf(obj, "fim2:\n");
    fprintf(obj, "  mov edx, [edx] \n");
    fprintf(obj, "  mov eax, [ncaracteres] ;retorna em eax o num de caracteres\n");
    fprintf(obj, "  ret\n");
    fprintf(obj, "\n");
    fprintf(obj, "EscreverInteiro:\n");
    fprintf(obj, "  mov dword [ncaracteres],0\n");
    fprintf(obj, "  mov dword [demarcador_de_sinal],0\n");
    fprintf(obj, "  push byte 0 ;empilha 0 para indicar o final da string_auxiliar_leitura\n");
    fprintf(obj, "  push byte 0ah\n");
    ...
    fprintf(obj, "  mov dword [demarcador_de_sinal],1\n");
    fprintf(obj, "  neg ecx\n");
    fprintf(obj, "  \n");
    fprintf(obj, "  inicio3:\n");
    ...
    fprintf(obj, "  \n");
    fprintf(obj, "fim3:\n");
    fprintf(obj, "  cmp dword [demarcador_de_sinal],0\n");
    ...
    fprintf(obj, "  \n");
    fprintf(obj, "  mov ebx, eax ; salva em ebx\n");
    fprintf(obj, "  ;multiplica o resultado_final_auxiliar por 10\n");
    fprintf(obj, "  mov dword eax, [edx]\n");
    fprintf(obj, "  shl dword eax,1\n");
    fprintf(obj, "  shl dword [edx], 3\n");
    fprintf(obj, "  add dword [edx], eax\n");
    fprintf(obj, "  adc dword[edx], ebx ;soma o resultado_final_auxiliar parcial com o digito\n");
    fprintf(obj, "\n");
    fprintf(obj, "  inc ecx ;muda o poneiro pro porximo digito\n");
    fprintf(obj, "  jmp inicio4\n");
    fprintf(obj, "\n");
    fprintf(obj, "fim4:\n");
    fprintf(obj, "  mov eax, [demarcador_de_sinal]\n");
    fprintf(obj, "  cmp eax, 0\n");
    ...
    fprintf(obj, "  mov eax, 3 ; ler\n");
    fprintf(obj, "  mov ebx, 1 ; teclado\n");
    fprintf(obj, "  int 0x80   ; ler(teclado, string_auxiliar_leitura, size bytes);\n");
    fprintf(obj, "  \n");
    fprintf(obj, "  ;chamada ao sistema retorna quantidade de caracteres em eax\n");
    fprintf(obj, "  ret\n");
    fprintf(obj, "  \n");
    ...
    fprintf(obj, "  mov eax, 4 ; escrever\n");
    fprintf(obj, "  mov ebx, 1 ; monitor\n");
    fprintf(obj, "  int 0x80   ; escrever(monitor, string_auxiliar_leitura, size bytes);\n");
    fprintf(obj, "  \n");
    fprintf(obj, "  ;chamada ao sistema retorna quantidade de caracteres em eax\n");
    fprintf(obj, "  ret\n");
    fprintf(obj, "  \n");
    fprintf(obj, "erro_fim:\n");
    fprintf(obj, "  mov     edx, tamanho_string_erro\n");
    fprintf(obj, "        mov     ecx, mensagem_string_erro\n");
